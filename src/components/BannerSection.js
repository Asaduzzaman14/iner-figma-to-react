        ...
        <div className='lg:mt-[70px]  lg:px-10 xl:px-[200px]'>
            <div className='relative'>
                ...
                <div className='absolute capitalize inset-0 flex  items-center left-4 lg:left-[54px] text-sm lg:text-5xl text-start text-white '>
                    <p className='font-solway banner_title w-[25%] lg:w-[30%] xl:w-[20%]'>
                        Making your <span className='text-[#14FF00] lg:text-[#FAFF00]'>real estate</span> purchase journey faster and transparent
