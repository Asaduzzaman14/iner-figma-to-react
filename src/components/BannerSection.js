  ...
  return (
    <div className="lg:mt-[70px]  lg:px-10 xl:px-[200px]">
      <div className="relative">
        ...
        <div className="absolute capitalize inset-0 flex  items-center left-4 lg:left-[54px] text-sm lg:text-md xl:text-5xl text-start text-white ">
          <p className="font-solway banner_title w-[103px] lg:w-[30%] xl:w-[20%]">
            Making your{" "}
