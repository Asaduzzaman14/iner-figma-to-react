      ...
      <div className="mt-5 lg:mt-[70px] text-center px-5  lg:px-10  xl:px-[100px] 2xl:px-[200px]">
        ...
        <div className="text-base lg:text-2xl ">
          <div className="text-start text-[#1A1A1A] opacity-60 pt-5 lg:pt-9">
            <p>
              There are several problems that buyers may face during real estate
              purchase in Bengaluru. Some of the major problems are as follows:
            </p>
            ...
            <div className=" pt-3 flex gap-4">
              ...
              <p>
                {" "}
                Fraud detection: AI-powered fraud detection systems are being
                used in the Indian real estate sector to prevent fraud and
                ensure the security of transactions. Fraud detection systems use
                machine learning algorithms to analyze data and identify
                patterns that indicate fraudulent activity. These systems can be
                used to detect fraud in property listings, title transfers, and
                financial transactions. To conclude, AI technology is
                transforming the Indian real estate sector and has made it more
                efficient, accurate, and cost-effective through various
                applications
              </p>
            </div>
            <div className=" pt-3 flex gap-4">
              <span>2. </span>
              <p>
                Lack of transparency: The lack of transparency in the real
                estate sector is another major problem in Bengaluru. This can
                include issues such as ambiguous pricing, hidden charges, and
                incomplete documentation. According to a survey by Magicbricks,
                nearly 60% of buyers in Bengaluru face issues related to
            ...
            <div className=" pt-3 flex gap-4">
              <span>3. </span>
              <p>
                High prices: Bengaluru has one of the highest property prices in
                India, which can make it difficult for buyers to find affordable
                housing. According to a report by Knight Frank, the average
                property prices in Bengaluru increased by 2.8% in Q1 2021,
                making it one of the top-performing cities in terms of price
                growth
              </p>
            </div>
            ...
            <div className=" pt-3 flex gap-4">
              ...
              <p>
                ...
                to property ownership and documentation. For example, the
                Karnataka High Court has issued orders to stop the registration
                of properties that are built on lake beds or other ecologically
                sensitive areas. This can create legal hurdles for buyers who
                have already invested in such properties.
              </p>
            </div>
