            ...
            <div className='py-[35px] px-3 px-lg:10 xl:px-[200px]'>
                <div className=' bg-[#F2F4F6] w-[360px] lg:w-full mx-auto p-4 md:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-2 items-center content-center  gap-4'>
                    ...
                    <div className='text-start grid content-center'>
                        ...
                        <h2 className='font-sans text-xl text-[#002550] lg:text-3xl font-semibold lg:font-bold pb-[10px] lg:pb-8'>The Most Expensive Bangalore Real Estate Sales For 2023</h2>
