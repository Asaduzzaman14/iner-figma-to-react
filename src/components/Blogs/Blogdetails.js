                    ...
                    <div className='text-base lg:text-2xl '>
                        <div className='text-start text-[#1A1A1A] opacity-60 pt-5 lg:pt-9'>
                            ...
                            <div>
                                ...
                                <p>Real estate is a complex industry with multiple parties involved in the buying and selling of properties. The traditional process of buying and selling a property involves a lot of paperwork, which can be time-consuming and prone to errors. Blockchain technology can help streamline this process by providing a secure, transparent, and efficient platform for real estate transactions. Some of the ways in which blockchain is being used in real estate are:</p>
                            </div>
                            ...
                            <div className='ms-3'>
                                <div className='pt-3'>
                                    ...
                                    <p className='ms-4'>One of the most significant applications of blockchain in real estate is the use of smart contracts. A smart contract is a self-executing contract that is programmed to automatically execute when certain conditions are met. In real estate, smart contracts can be used to automate the transfer of property ownership and the release of funds once the conditions of the contract are met. This can help reduce the time and cost involved in real estate transactions, as well as reduce the risk of fraud.</p>
                                </div>
                                ...
                                <div className='pt-3'>
                                    ...
                                    <p className='ms-4'>Another area where blockchain can be useful in real estate is property title management. Property titles are a crucial component of real estate transactions, as they establish ownership of the property. However, the current system of property title management is often prone to errors, fraud, and disputes. Blockchain technology can provide a secure and transparent platform for managing property titles, which can help reduce the risk of fraud and disputes.</p>
                                </div>
                            ...
                            <div>
                                ...
                                <div className='pt-3'>
                                    <div className='flex gap-1'>
                                        <span>1. </span>
                                        <p className=''> Increased transparency - Blockchain technology provides a secure and transparent platform for real estate transactions, which can help reduce the risk of fraud and increase transparency.</p>
                                    </div>
                                </div>
                                ...
                                <div className='pt-3'>
                                    <div className='flex gap-1'>
                                        <span>2. </span>
                                        <p className=''>Reduced costs- By automating the real estate transaction process and reducing the need for intermediaries, blockchain can help reduce the costs involved in real estate transactions.
                                        </p>
                                    </div>
                                </div>
                                <div className='pt-3'>
                                    <div className='flex gap-1'>
                                        <span>3. </span>
                                        <p className=''> Improved efficiency- The use of smart contracts and other blockchain-based technologies can help automate the real estate transaction process, which can help improve efficiency and reduce the time involved in real estate transactions.</p>
                                    </div>
                                </div>
                                ...
                                <div className='pt-3'>
                                    <div className='flex gap-1'>
                                        <span>4. </span>
                                        <p className=''> Increased security- Blockchain technology provides a secure platform for real estate transactions, which can help reduce the risk of fraud and increase the security of transactions.</p>
                                    </div>
                                </div>
