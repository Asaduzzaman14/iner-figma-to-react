...
const About = () => {
    return (
        <div className='font-sans mt-6 lg:mt-[35px] px-5 px-lg:10 xl:px-[200px]'>

            <div className='w-[360px] md:w-full mx-auto bg-[#E6EAEE] p-4 md:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-2 items-center content-center gap-[10px] lg:gap-[30px]'>
