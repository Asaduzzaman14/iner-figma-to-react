...
const About = () => {
    return (
        <div className='mt-6 lg:mt-[35px] px-5 px-lg:10 xl:px-[200px]'>

            <div className='w-[360px] md:w-full mx-auto bg-[#E6EAEE] p-4 md:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-2 items-center content-center  gap-4'>

                <div>
                    <img className='w-[340px] md:w-full mx-auto' src={aboutImg} alt="" />
                </div>
                <div className='text-start font-sans grid content-center'>
                    <h2 className='font-sans text-sm md:text-xl text-[#1A1A1A] lg:text-[36px] font-semibold pb-[10px] lg:pb-8'>Who We Are</h2>
