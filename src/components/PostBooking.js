    ...
    return (
        <Slider {...settings}>
            ...
            <div>
                <div className='card w-[360px] lg:w-[711px] p-4 lg:p-6'>
                    <div >
                        ...
                        <p className='cart-desc text-[#1A1A1A] opacity-60 text-sm lg:text-lg text-justify'>Real estate is still the most informal industry in India with certain malpractices. It is frequently observed that sellers create multiple rights on the same property which makes the purchase experience unpleasant. Here, we bring the proposition of regular checks on the government records like the encumbrance certificate of the particular property. This is further supplemented with a legal opinion report by the expert. This ensures that...</p>
            ...
            <div>
                <div className='card w-[360px] lg:w-[711px] p-4 lg:p-6'>
                    <div >
                        <img className="w-[330px] h-[245px] lg:w-full lg:h-full" src={iamge5} alt="" />
                        <h2 className='cart-title text-xl'>TDS & Capital Gain</h2>
                        <p className='cart-desc text-[#1A1A1A] opacity-60 text-sm lg:text-lg text-justify'>Adhering to compliance is strictly required in the process of property purchase. As per the Income tax Act 1956, if the property value is more than 50 Lakhs then TDS @ 1% needs to be deducted by the buyer out of the sale consideration and the same needs to be paid on behalf of the seller to the Central Government of India. Failing to deduct TDS and pay to the government of India within the due date, the applicable monthly interest rate is...</p>
