    ...
    return (
        <div className='px-5 px-lg:10 xl:px-[200px]'>
            <div className='relative text-center pb-[20px]'>
                <h2 className='title text-base lg:text-[32px] pt-0 pb-[5px] lg:py-[25px]'>Our Team Members</h2>
                    ...
                    <div>
                        <div className='card w-[360px] lg:w-[455px] p-4 lg:p-6'>
                            ...
                            <div className='text-end'>
                                <Link to='/ourTeam' className='font-semibold text-end pt-4  text-[#1A1A1A]  lg:font-normal text-[16px] opacity-60  cursor-pointer'> View More</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card w-[360px] lg:w-[455px] p-4 lg:p-6'>
                            <div className='text-start'>
                                ...
                                <h2 className='pt-5 pb-3 text-xl text-[#002550] font-semibold'>Deepak Shukla</h2>
                                {/* <div className='py-3'>
                    ...
                    <div>
                        <div className='card w-[360px] lg:w-[455px] p-4 lg:p-6'>
                            <div className='text-start'>
                                ...
                                <h2 className='pt-5 pb-3 text-xl text-[#002550] font-semibold'>Alok Kumar Singh</h2>
                                {/* <div className='py-3'>
                            ...
                            <div className='text-end'>
                                <Link to="/ourTeam" className='font-semibold  pt-4 text-[#1A1A1A]  lg:font-normal text-[16px] opacity-60 cursor-pointer'> View More</Link>
                            </div>
                        </div>
                    </div>
