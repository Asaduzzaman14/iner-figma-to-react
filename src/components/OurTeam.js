                ...
                <div className='grid gap-[46px] grid-cols-1 lg:grid-cols-3 '>
                    ...
                    <div className='card w-[360px] lg:w-[400px] xl:w-[455px] p-4 lg:p-6'>
                        <div className='text-start'>
                            <img className='w-[330px]' src={image1} alt="" />
                            ...
                            <p className='cart-desc text-sm lg:text-xl text-[#1A1A1A] opacity-60 text-justify'>A Chartered Accountant & Company Secretary, has over a decade of experience in managing realty focused venture capital funds, and was heading Azure Capital Advisors Private Limited. He has also been...</p>
                        </div>
                        <div>
                    ...
                    <div className='card w-[360px] md:w-[355px] p-4 lg:p-6'>
                        <div className='text-start'>
                            <img className='w-[330px]' src={image2} alt="" />
                            <h2 className='pt-5 text-xl text-[#002550] font-semibold'>Deepak Shukla</h2>
                            <span className='text-[#1A1A1A] opacity-40 pb-3'>Co-Founder</span>
                            <p className='cart-desc text-sm lg:text-xl text-[#1A1A1A] opacity-60 text-justify'>Deepak Shukla has completed his B.Tech (hons.) from the Indian Institute of Technology (IIT) Kharagpur and obtained an MBA from the Indian Institute of Management (IIM) Ahmedabad, India. He has an overall experience...</p>
                        </div>
                        <div>
                            <p className='text-end py-4 text-[#002550] font-normal text-[16px] opacity-60 cursor-pointer'> View More</p>
                        </div>
                    ...
                    <div className='card w-[360px] md:w-[355px] p-4 lg:p-6'>
                        <div className='text-start'>
                            ...
                            <p className='cart-desc text-sm lg:text-xl text-[#1A1A1A] opacity-60 text-justify'>Entrepreneur with pedigree from IIT-BHU and IIML, and more than 25 years of experience in management responsibilities in top tier companies including Infosys, Infosys BPO and Azure Capital. Co-Founded Azure Capital, a Real..</p>
                        </div>
                        <div>
                            <p className='text-end py-4 text-[#002550] font-normal text-[16px] opacity-60 cursor-pointer'> View More</p>
                        </div>
